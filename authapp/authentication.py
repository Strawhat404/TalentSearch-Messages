    ...
    def authenticate(self, request):
        ...
        try:
            ...
            if token['exp'] < current_time:
                ...
                raise exceptions.AuthenticationFailed('Token is expired', code='token_expired')
            ...
            if user is None or not user.is_active:
                ...
                raise exceptions.AuthenticationFailed('User not found or inactive', code='user_not_found')
            ...
            if token_pwd_time:
                ...
                if user_pwd_time > token_pwd_time:
                    ...
                    raise exceptions.AuthenticationFailed('Token is invalid due to password change', code='password_changed')
            ...
            raise exceptions.AuthenticationFailed(str(e), code='token_not_valid')
