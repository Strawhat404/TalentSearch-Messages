...
class JobSerializerTests(TestCase):
    ...
    def test_serializer_missing_required_fields(self):
        ...
        self.assertEqual(str(serializer.errors['talents'][0]), 'Talents cannot be blank.')
        self.assertEqual(str(serializer.errors['first_name'][0]), 'First Name cannot be blank.')
        self.assertEqual(str(serializer.errors['last_name'][0]), 'Last Name cannot be blank.')
        self.assertEqual(str(serializer.errors['company_name'][0]), 'Company Name cannot be blank.')
        self.assertEqual(str(serializer.errors['job_title'][0]), 'Job Title cannot be blank.')
        self.assertEqual(str(serializer.errors['country'][0]), 'Country cannot be blank.')
    ...
    def test_serializer_blank_required_fields(self):
        ...
        for field in ['talents', 'project_type', 'organization_type', 'first_name', 'last_name', 'company_name', 'job_title', 'country']:
            ...
            self.assertEqual(str(serializer.errors[field][0]), f"{field.replace('_', ' ').title()} cannot be blank.")
