...
# """
# Django model for jobs, storing job-related information linked to a profile.
# """
...
# class Job(models.Model):
#     """
#     Represents a job posting or project associated with a profile.
#     """
...
# class Application(models.Model):
#     """
#     Represents a job application submitted by a profile.
#     """
#     profile_id = models.ForeignKey(Profile, on_delete=models.CASCADE)  # Made nullable
#     job = models.ForeignKey(Job, on_delete=models.CASCADE)
#     opportunity_description = models.TextField()
#     applied_at = models.DateTimeField(auto_now_add=True)
#
...
#         """
#         String representation of the Application instance.
#         Returns the profile name and job title.
#         """
#         return f"{self.profile_id.name if self.profile_id else 'Unknown'} applied for {self.job.job_title}"