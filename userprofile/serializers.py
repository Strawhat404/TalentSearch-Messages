...
#         ]
#         read_only_fields = ['id', 'age', 'created_at', 'verified', 'flagged']
#
...
#         """
#         Create a new Profile instance and update the associated user's email if provided.
#         """
...
#         """
#         Update an existing Profile instance, handling file uploads and email updates.
...
#             instance.user.email = validated_data['user'].pop('email')
#             instance.user.save()
